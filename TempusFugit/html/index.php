...
<html lang="it">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <a class="navbar-brand" href="#" style="position:absolute; top:15px; left:60px;"><b><i>Tempus Fugit</i></b></a>
    </nav>
    <div class="jumbotron" id="jumbotron">
      <div class="container">
        <h1 class="display-4">Buongiorno guest!</h1>
    ...
    <div class="container" >
      ...
      <div class="page-header">
        <h1 id="timeline">Prossimi eventi:</h1>
      </div>
      <ul class="timeline" style="left:-16px;">
        <li>
