...
<html lang="it">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent"><br/>
        <ul class="navbar-nav mr-auto" style="margin-left:40%;">
          <!--Corsi-->
          <li class="nav-item"><a class="nav-link" href="#">Corsi<span class="sr-only">(current)</span></a></li>
          <!--Comunicazioni-->
    ...
    <div class="container">
      <!--Corsi-->
      <div class="row" style="margin-top:16px;left:-16px;">
        <div class="col-sm col-sm-custom">
          <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title" id="nomeCorso">Calcetto</h5>
              <p class="card-text" id="descrizioneCorso">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              <a href="#" class="card-link">Iscriviti al corso</a>
              <a href="corso.php" class="card-link">Vai al corso</a>
            </div>
          </div>
        </div>
      </div>
